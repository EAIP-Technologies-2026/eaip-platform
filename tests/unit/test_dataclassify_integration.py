"""Tests for :mod:`eaip.dataclassify.integration`."""
...
class TestDataClassifyRuntimeModule:
    def test_name(self) -> None:
        module = DataClassifyRuntimeModule()
        assert module.name == "dataclassify"
    ...
    def test_classifier_available(self) -> None:
        module = DataClassifyRuntimeModule()
    ...
    def test_health_check_property(self) -> None:
        ...
        assert module.health_check.name == "dataclassify"
