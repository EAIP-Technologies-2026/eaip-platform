"""Tests for :mod:`eaip.dataencrypt.integration`."""
...
class TestDataEncryptRuntimeModule:
    def test_name(self) -> None:
        module = DataEncryptRuntimeModule()
        assert module.name == "dataencrypt"
    ...
    def test_encryptor_available(self) -> None:
        module = DataEncryptRuntimeModule()
        assert module.encryptor is not None

    def test_health_check_property(self) -> None:
        module = DataEncryptRuntimeModule()
        assert module.health_check is not None
        assert module.health_check.name == "dataencrypt"
